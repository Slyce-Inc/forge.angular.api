...
import { TagFoundDoc } from '../model/tagFoundDoc';
...
export class NotificationsService {
    ...
    public notificationsNotification(accountId: string, jobId: string, body?: TagFoundDoc, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/accounts/${encodeURIComponent(String(accountId))}/notifications/${encodeURIComponent(String(jobId))}/`,
            body,
            {
